    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('information_of_client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Cliente')),
                ...
                ('video_board', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='video_board', to='products.VideoBoard')),
            ],
            options={
